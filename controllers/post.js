...
exports.postArticle = function(req, res, next) {
  ...
  blogPost.body = markdown.toHTML(req.body.text);
  blogPost.date = new Date(); // (new Date()).Format("yyyy-MM-dd hh:mm:ss");
...
exports.getAll = function(req, res, next) {
  console.log(req.params.name);
    BlogPost.find({'username': req.params.name}, function(err,blogs){
